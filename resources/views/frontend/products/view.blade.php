                    ...
                    <div class="col-md-8">
                        <h2 class="mb-0">
                            ...
                            @if ($products->trending)
                                <label for="font-size: 16px" class="float-end badge bg-danger trending_tag">Trending</label>
                            @endif
                        </h2>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-10">
                                <br />
                                <button type="button" class="btn btn-success me-3 addToCartBtn float-start">Add to Cart<i
